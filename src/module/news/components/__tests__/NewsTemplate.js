...
describe('NewsTemplate', () => {
  ...
  it('Snapshot of NewsTemplate when newsLoading is true', () => {
    const wrapper = shallow(<NewsTemplate {...props} />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
  it('Snapshot of NewsTemplate when newsLoading is false ', () => {
    ...
    const wrapper = shallow(<NewsTemplate {...propsLoadingFalse} />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
  it('Snapshot of NewsTemplate when error ', () => {
    const propsNewsError = {
      ...props,
      ...{
        newsLoading: false,
        newsError: 'err'
    ...
    const wrapper = shallow(<NewsTemplate {...propsNewsError} />);
    expect(toJSON(wrapper)).toMatchSnapshot();
  });
});
